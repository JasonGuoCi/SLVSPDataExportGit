...
namespace SLVSPDataExportAll
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            LogHelper.WriteLogSuccess("Export begin " + DateTime.Now.ToString("ddMMyyyyhhmmss"), logPathSuccess);
            Write2CSV();
            LogHelper.WriteLogSuccess("Export end " + DateTime.Now.ToString("ddMMyyyyhhmmss"), logPathSuccess);
