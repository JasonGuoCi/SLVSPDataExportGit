...
namespace SLVSPDataExportAll
{
    public class ListHelperCSOM
    {
        ...
        public static DataTable GetItems(DataRow[] rows, string siteUrl, string userName, string pwd, string domain, string listName, string viewName, string logPath, string successLogPath)
        {
            DataTable dt = new DataTable();
            if (listName != "Project Basic List")
            {
